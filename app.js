...
for (let k=0; k < selects.length; k++){
    ...
    if (val[0] == "a"){
        ...
        document.getElementById("apre").innerHTML = localStorage.getItem("team1_a_sum");
        document.getElementById("everything_sum").innerHTML = Number(localStorage["team1_a_sum"]) + Number(localStorage["team1_b_sum"] + Number(localStorage["team1_c_sum"]) + Number(localStorage["team1_d_sum"]));
        document.getElementById("everything_sum").innerHTML = localStorage["team1_sum"];
    }
    if (val[0] == "b"){
